...
public class GetPathFromLocation extends AsyncTask<String, Void, PolylineOptions> {
    ...
    private String API_KEY = "AIzaSyAJ1gx1nwkfFjjcQd7a-UAqJBM-KxANtbM";
    private LatLng source, destination;
    private DirectionPointListener resultCallback;
    private Context context;
    public static List<HashMap<String, String>> listOfPaths;

    public GetPathFromLocation(Context context, LatLng source, LatLng destination, DirectionPointListener resultCallback) {
        this.source = source;
        ...
        try {
            ...
            try {
                ...
                for (int i = 0; i < routes.size(); i++) {
                    ...
                    lineOptions.color(context.getResources().getColor(R.color.colorSecond));
