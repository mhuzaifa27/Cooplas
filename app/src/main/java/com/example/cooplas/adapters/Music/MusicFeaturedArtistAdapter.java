...
public class MusicFeaturedArtistAdapter extends RecyclerView.Adapter<MusicFeaturedArtistAdapter.TravelBuddyViewHolder> {
    private List<String> data;
    Context context;
    private boolean isLoadingAdded;

    public MusicFeaturedArtistAdapter(List<String> data, Context context) {
        this.data = data;
    ...
    public TravelBuddyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_music_featured_artist, parent, false);
