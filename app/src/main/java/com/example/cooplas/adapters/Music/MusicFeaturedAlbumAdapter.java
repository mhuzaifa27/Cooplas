...
import com.example.cooplas.activities.Music.AlbumActivity;
import com.example.cooplas.activities.Music.ArtistDetailActivity;

import java.util.List;

public class MusicFeaturedAlbumAdapter extends RecyclerView.Adapter<MusicFeaturedAlbumAdapter.TravelBuddyViewHolder> {
    private List<String> data;
    Context context;
    private boolean isLoadingAdded;

    public MusicFeaturedAlbumAdapter(List<String> data, Context context) {
        this.data = data;
    ...
    public TravelBuddyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_music_featured_album, parent, false);
