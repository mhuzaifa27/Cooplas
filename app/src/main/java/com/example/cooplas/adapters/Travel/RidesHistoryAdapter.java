...
public class RidesHistoryAdapter extends RecyclerView.Adapter<RidesHistoryAdapter.TravelBuddyViewHolder> {
    private List<String> data;
    Context context;

    public RidesHistoryAdapter(List<String> data, Context context) {
        this.data = data;
    ...
    public TravelBuddyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_ride_history, parent, false);
