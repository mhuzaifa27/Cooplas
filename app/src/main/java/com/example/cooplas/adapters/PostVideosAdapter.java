...
public class PostVideosAdapter extends RecyclerView.Adapter<PostVideosAdapter.TravelBuddyViewHolder> {
    ...
    public PostVideosAdapter(List<String> data, Context context, Activity activity) {
        this.data = data;
    ...
    public TravelBuddyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_post_videos, parent, false);
