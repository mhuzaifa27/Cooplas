...
public class MusicPlaylistSongsAdapter extends RecyclerView.Adapter<MusicPlaylistSongsAdapter.TravelBuddyViewHolder> {
    private List<String> data;
    Context context;
    private boolean isLoadingAdded;

    public MusicPlaylistSongsAdapter(List<String> data, Context context) {
        this.data = data;
    ...
    public TravelBuddyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_music_track, parent, false);
