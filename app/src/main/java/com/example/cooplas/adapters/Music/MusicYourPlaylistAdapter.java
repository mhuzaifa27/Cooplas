...
public class MusicYourPlaylistAdapter extends RecyclerView.Adapter<MusicYourPlaylistAdapter.TravelBuddyViewHolder> {
    private List<String> data;
    Context context;
    private boolean isLoadingAdded;

    public MusicYourPlaylistAdapter(List<String> data, Context context) {
        this.data = data;
    ...
    public TravelBuddyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_music_your_playlist, parent, false);
