...
public class SearchUserAdapter extends Adapter<SearchUserAdapter.ViewHolder> {
    private List<Result> data;
    private Activity activity;

    public SearchUserAdapter(Activity activity, List<Result> data) {
        this.data = data;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        Result model = data.get(position);
