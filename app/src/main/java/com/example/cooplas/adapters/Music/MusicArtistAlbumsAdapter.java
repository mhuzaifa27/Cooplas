...
public class MusicArtistAlbumsAdapter extends RecyclerView.Adapter<MusicArtistAlbumsAdapter.TravelBuddyViewHolder> {
    private List<String> data;
    Context context;
    private boolean isLoadingAdded;

    public MusicArtistAlbumsAdapter(List<String> data, Context context) {
        this.data = data;
