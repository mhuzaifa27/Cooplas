...
public class MusicTrendingAdapter extends RecyclerView.Adapter<MusicTrendingAdapter.TravelBuddyViewHolder> {
    private List<String> data;
    Context context;
    private boolean isLoadingAdded;

    public MusicTrendingAdapter(List<String> data, Context context) {
        this.data = data;
    ...
    public TravelBuddyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_music_trending, parent, false);
