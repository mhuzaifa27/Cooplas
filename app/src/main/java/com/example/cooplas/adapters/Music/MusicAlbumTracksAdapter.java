...
public class MusicAlbumTracksAdapter extends RecyclerView.Adapter<MusicAlbumTracksAdapter.TravelBuddyViewHolder> {
    private List<String> data;
    Context context;
    private boolean isLoadingAdded;

    public MusicAlbumTracksAdapter(List<String> data, Context context) {
        this.data = data;
