...
public class OrderedListAdapter extends RecyclerView.Adapter<OrderedListAdapter.TravelBuddyViewHolder> {
    private List<String> data;
    Context context;

    public OrderedListAdapter(List<String> data, Context context) {
        this.data = data;
