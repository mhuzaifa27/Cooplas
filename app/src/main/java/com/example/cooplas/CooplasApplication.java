 ...
 */
public class CooplasApplication extends Application {
    Context mContext;

    private static final String TAG = "CooplasApplication";
    public static CooplasApplication cooplasApplication;

    public static CooplasApplication getCooplasApplication() {
        return cooplasApplication;
    }
    ...
    public void onCreate() {
        super.onCreate();
        mContext = CooplasApplication.this;
        cooplasApplication = this;
    ...
    public void logout(){
        try {
            FirebaseAuth.getInstance().signOut();
            FunctionsKt.clearSharedPreference(this);
        } catch (Exception e) {
        }
    }
}
