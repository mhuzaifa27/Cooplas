...
import com.example.cooplas.adapters.Music.MusicAllYourPlaylistAdapter;
...
public class AllYourPlaylistActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "AllYourPlaylistActivity";
    private Context context = AllYourPlaylistActivity.this;
    private Activity activity = AllYourPlaylistActivity.this;

    private EventBus eventBus = EventBus.getDefault();
    private BroadcastReceiver mNetworkReceiver;
    private View parentLayout;

    private RecyclerView rv_your_playlist;
    private GridLayoutManager layoutManagerYourPlaylist;

    private List<String> yourPlayList = new ArrayList<>();

    private MusicAllYourPlaylistAdapter musicAllYourPlaylistAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_your_playlist);
    ...
    private void setData() {
        musicAllYourPlaylistAdapter.addAll(yourPlayList);
        progressHUD.dismiss();
    }
    ...
    private void initComponents() {
        ...
        musicAllYourPlaylistAdapter =new MusicAllYourPlaylistAdapter(yourPlayList,context);
        rv_your_playlist.setAdapter(musicAllYourPlaylistAdapter);
    }
