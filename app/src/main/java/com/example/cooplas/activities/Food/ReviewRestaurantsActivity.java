...
public class ReviewRestaurantsActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "ReviewRestaurantsActivity";
    private Context context=ReviewRestaurantsActivity.this;
    private Activity activity=ReviewRestaurantsActivity.this;
    ...
    private void initComponents() {
        ...
        tv_title.setText(R.string.review_restaurant);
