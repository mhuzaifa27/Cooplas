...
import com.example.cooplas.AgoraClasses.RTM.MessageActivity;
...
public class OtherUserProfileActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private String receiverId,email;
    private User user;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        /*chatManager= AGApplication.the().getChatManager();*/
        progressHUD = KProgressHUD.create(OtherUserProfileActivity.this);
...
//    }
    ...
    private void getPosts() {
        ...
        Call<ProfileModel> call = apiInterface.getOtherUserWall("Bearer " + accessToken,userId, String.valueOf(offsetValue));
                ...
                if (response.isSuccessful()) {
                    ...
                    userService.setOnChangedListener(new ChangeEventListener() {
                        ...
                        public void onDataChanged() {
                            email=wallModel.getEmail();
                            receiverId = userService.getUserByEmail(email).getUserId();
...
//            return;
    ...
    private void populateFeedAdapter() {
        ...
        adapter = new ProfileFeedAdapter(OtherUserProfileActivity.this, arrayList, wallModel);
...
//        });
    ...
    private void initComponents() {
        ...
        swipeRefreshLayout.setOnRefreshListener(OtherUserProfileActivity.this);
        ...
        rl_message.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(OtherUserProfileActivity.this, SingleMessagingActivity.class);
                intent.putExtra(Constants.ID, receiverId);
                intent.putExtra(Constants.START_NAME, wallModel.getFirstName()+" "+wallModel.getLastName());
                intent.putExtra(Constants.IMAGE, wallModel.getProfilePic());
