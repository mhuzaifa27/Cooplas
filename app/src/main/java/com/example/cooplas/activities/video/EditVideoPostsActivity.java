package com.example.cooplas.activities.video;
...
public class EditVideoPostsActivity extends AppCompatActivity {
        ...
        post_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (descriptionVal.isEmpty()) {
                    Toast.makeText(EditVideoPostsActivity.this, "Please enter description", Toast.LENGTH_SHORT).show();
                    return;
                }
//                if (topicVal.isEmpty()) {
...
//                }
    ...
    private void getPosts() {
        ...
        KProgressHUD progressHUD = KProgressHUD.create(EditVideoPostsActivity.this).show();
        progressHUD.show();
    ...
    private void populateRecyclerView() {
        ...
        adapter = new HomeCreatePostImagesAdapter(EditVideoPostsActivity.this, listMedia, 0);
    ...
    private void MediaSelectionAlert() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(EditVideoPostsActivity.this);
    ...
    private void PickImages() {
        new ImagePicker.Builder(EditVideoPostsActivity.this)
    ...
    private void PickVideo() {
        ...
        new VideoPicker.Builder(EditVideoPostsActivity.this)
    ...
    private void uploadPost() {
        ...
        KProgressHUD progressHUD = KProgressHUD.create(EditVideoPostsActivity.this).show();
        progressHUD.show();
        String accessToken = FunctionsKt.getAccessToken(EditVideoPostsActivity.this);
        APIInterface apiInterface = APIClient.getClient(getApplicationContext()).create(APIInterface.class);
...
//            builder.addFormDataPart("files[]", file.getName(), RequestBody.create(MediaType.parse("multipart/form-data"), file));
        ...
        call.enqueue(new Callback<CreatePostModel>() {
            ...
            public void onResponse(Call<CreatePostModel> call, Response<CreatePostModel> response) {
                ...
                progressHUD.dismiss();
                if (response.isSuccessful()) {
                    Toast.makeText(EditVideoPostsActivity.this, "Profile Updated successfully", Toast.LENGTH_SHORT).show();
