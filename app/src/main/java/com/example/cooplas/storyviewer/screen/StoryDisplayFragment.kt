package com.example.cooplas.storyviewer.screen
...
import com.c2m.storyviewer.utilsStory.OnSwipeTouchListener
import com.c2m.storyviewer.utilsStory.hide
import com.c2m.storyviewer.utilsStory.show


import com.example.cooplas.R
import com.example.cooplas.storyviewer.screen.MainActivityStory.MainActivityStory
...
class StoryDisplayFragment : Fragment(),
    ...
    override fun onResume() {
        ...
        if (counter == 0) {
            ...
            // restart animation
            counter = MainActivityStory.progressState.get(arguments?.getInt(EXTRA_POSITION) ?: 0)
    ...
    private fun savePosition(pos: Int) {
        MainActivityStory.progressState.put(position, pos)
    }

    private fun restorePosition(): Int {
        return MainActivityStory.progressState.get(position)
    }
